...
/***/ (function(module, exports, __webpack_require__) {
	...
	var HeaderRow = React.createClass({
	  ...
	  getSortableHeaderCell: function getSortableHeaderCell(column) {
	    ...
	    return React.createElement(SortableHeaderCell, { columnKey: column.key, onSort: this.props.onSort, sortDirection: sortDirection, headerRenderer: column.headerRenderer });
	  },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SortableHeaderCell = React.createClass({
	  ...
	  render: function render() {
	    ...
	    // let content = this.props.headerRenderer ? React.createElement(this.props.headerRenderer, null) :  this.props.column.name;
	    ...
	    return React.createElement(
	      ...
	      this.props.headerRenderer ? this.props.headerRenderer() : this.props.column.name
	    );
	  }
	});
